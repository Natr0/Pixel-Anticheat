...
PIXEL_A = {}
PIXEL_A.Version = 1.7
PIXEL_A.License = ""  --Put here your license
PIXEL_A.ConnectCheck = true
PIXEL_A.UseOneSyncInfinity = true
PIXEL_A.UseEssentialmode = false
PIXEL_A.UseExtended = true
...
PIXEL_A.DiscordPIXELWarn      = "https://discord.com/api/webhooks"
PIXEL_A.DiscordPIXELExplosion = "https://discord.com/api/webhooks"
PIXEL_A.DiscordPIXELObject    = "https://discord.com/api/webhooks"
PIXEL_A.DiscordPIXELBan       = "https://discord.com/api/webhooks"
PIXEL_A.DiscordPIXELScreens   = "https://discord.com/api/webhooks/"
PIXEL_A.DiscordPIXEL          = "https://discord.com/api/webhooks"
...
PIXEL_A.AntiFakeChatMessagesMode = "BAN" --[ WARN | KICK | BAN | GBAN ] 
...
PIXEL_A.BlacklistedWordsDetectionMode = "BAN" --[ WARN | KICK | BAN | GBAN ] 
